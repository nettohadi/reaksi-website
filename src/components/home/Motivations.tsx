    ...
    <div className="wrapper flex-column secondary-font-color primary-bg-color">
      <div className="inner-wrapper">
        ...
        <div class="secondary-bg-color primary-font-color rounded-container">
          <p style={styles.p}>
            "Another JavaScript framework, what's the point of doing this".
            That's what most of you probably thinking right now. We know that
            JavasScript ecosystem is already very crowded with UI libraries. And
            you know what, we're not trying to compete with them or to be the
            next big thing.
          </p>
          <p style={styles.p}>
